...
var TestimonialSliderModalController = BlockModalController.extend({
  
  add_child_link_text: "Add a testimonial!",
  child_block_header_text: "Testimonials",
 ...
 //       .append($('<img/>').attr('id', 'block_' + b.id + '_image').attr('src', 'http://placehold.it/150x75'))       
        .append($('<span/>').append(that.child_block_value('name', b)))
        .click(function(e) {
          e.preventDefault();
          e.stopPropagation();
